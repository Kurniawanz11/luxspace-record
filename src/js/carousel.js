...
function carouselCalculateOffset() {
    const carouselOffset = carouselContainer.getBoundingClientRect();
...
function slide(wrapper,items) {
    ...
    itemToShow = 4, slides = items.getElementsByClassName("card"), slideLength = slides.Length,
    ...
    items.addEventListener("touchsend", dragEnd);
    ...
    function dragStart (e) {
        ...
        if (e.type == "touchstart") {
            ...
            posX1 = e.clientX;
            document.onemouseup = dragEnd;
            document.onemousemove = dragAction;
        }
    }
    ...
    function shifSlide(direction, action) {
